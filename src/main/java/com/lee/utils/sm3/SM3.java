...
//		      System.out.println("");
    ...
    {
        return back(ConverterUtil.intToBytes(num));
    }

    private static int bigEndianByteToInt(byte[] bytes)
    {
        return ConverterUtil.byteToInt(back(bytes));
    }
    ...
    public static byte[] padding(byte[] in, int bLen)
    {
        ...
        pos += padd.length;
        byte[] tmp = back(ConverterUtil.longToBytes(n));
    ...
    public static void main(String[] args) {
        ...
        System.out.println(ConverterUtil.byteToHex(msg1));
