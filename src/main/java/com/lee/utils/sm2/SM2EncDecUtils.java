...
//      System.out.println("C3 " + Util.byteToHex(c3));
        ...
        // C1 | C3 | C2
        return ConverterUtil.byteToHex(c1.getEncoded()) + ConverterUtil.byteToHex(c3) + ConverterUtil.byteToHex(source);
    }
    ...
    public static byte[] decrypt(byte[] privateKey, byte[] encryptedData) throws IOException {
        ...
        String data = ConverterUtil.byteToHex(encryptedData);
        /***分解加密字串 C1 | C2 | C3
         ...
         * （C2 = encryptedData.length * 2 - C1长度  - C2长度）
         */
        byte[] c1Bytes = ConverterUtil.hexToByte(data.substring(0, 130));
        int c2Len = encryptedData.length - 97;
        byte[] c3 = ConverterUtil.hexToByte(data.substring(130, 130 + 64));
        byte[] c2 = ConverterUtil.hexToByte(data.substring(194, 194 + 2 * c2Len));
...
/*    public static BigInteger[] Sm2Sign(byte[] md, AsymmetricCipherKeyPair keypair)
    ...
    public static void main(String[] args) throws Exception {
        ...
        String cipherText = SM2EncDecUtils.encrypt(ConverterUtil.hexToByte(pubk), sourceData);
        ...
        plainText = new String(SM2EncDecUtils.decrypt(ConverterUtil.hexToByte(prik), ConverterUtil.hexToByte(cipherText)));
