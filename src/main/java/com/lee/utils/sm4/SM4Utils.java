...
//    private boolean hexString = false;
    ...
    public String encryptData_ECB(String plainText) {
        try {
            ...
            byte[] keyBytes;
            if (hexString) {
                keyBytes = ConverterUtil.hexStringToBytes(secretKey);
            } else {
            ...
            return ConverterUtil.byteToHex(encrypted);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
    ...
    public String decryptData_ECB(String cipherText) {
        try {
            byte[] encrypted = ConverterUtil.hexToByte(cipherText);
    ...
    public String encryptData_CBC(String plainText) {
        try {
            ...
            if (hexString) {
                keyBytes = ConverterUtil.hexStringToBytes(secretKey);
                ivBytes = ConverterUtil.hexStringToBytes(iv);
            } else {
                keyBytes = secretKey.getBytes();
                ivBytes = iv.getBytes();
            }
    ...
    public static void main(String[] args) throws IOException {
        ...
        String s = ConverterUtil.byteToHex(plainText.getBytes());
